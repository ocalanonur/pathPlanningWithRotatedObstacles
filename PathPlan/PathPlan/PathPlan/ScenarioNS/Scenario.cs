        ...
        public void CreateObstacles()
        {
            ...
            switch (name)
            {
                ...
                case "Scenario2":
                    ...
                    obstacles.Add(obs);
                    game.Components.Add(obs);
                    obs = new Obstacle(game, spriteBatch, texture, 420, 10, 50, 250, 0.9F);
                    obstacles.Add(obs);
                    game.Components.Add(obs);
                    obs = new Obstacle(game, spriteBatch, texture, 480, 200, 50, 250, 0.2F);
                    obstacles.Add(obs);
                    game.Components.Add(obs);
                    obs = new Obstacle(game, spriteBatch, texture, 20, 50, 150, 60, 0.7F);
                    obstacles.Add(obs);
                    game.Components.Add(obs);
                    obs = new Obstacle(game, spriteBatch, texture, 600, 100, 120, 40, 0.7F);
                    obstacles.Add(obs);
                    game.Components.Add(obs);
                    obs = new Obstacle(game, spriteBatch, texture, 600, 300, 120, 40, 2.5F);
                    obstacles.Add(obs);
                    game.Components.Add(obs);
                    break;
            }
